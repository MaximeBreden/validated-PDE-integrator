function [problem,plotdata] = ivpdataFisher2
% data for Fisher's equation
% to get error bound 10^-3
%
...
griddata.D=D;% =0 means no skew (uniform grid); =1 is maximum skew
griddata.skew=0.9;  
...
%% !! Specifically chosen smmall to be the main contraint !!
rstar=1e-3;
