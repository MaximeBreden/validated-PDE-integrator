function [problem,plotdata] = ivpdataFisher4
...
% subgrid for time stepping (D0=1 for no subgrid)
subgriddata.D0=3;
...
nu=1.0001;
eps0=1; % eps_{infty N} in the latex
eps1=1; % eps_{infty} in the latex
...
problem = preprocessdata(problem,initialdata,griddata,symmetry,scale,subgriddata);
problem.K = K;

%% Final settings %%
problem.useintervals = true;
